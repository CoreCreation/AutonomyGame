...
// Type: AutonomyTheGame.Autonomy0._1.PlayerSpawn
...
{
  [Serializable]
  internal class PlayerSpawn : Tile
  {
    public PlayerSpawn(ContentManager Content, float x, float y)
      : base(x, y)
      => this.Instil(Content);
    ...
    protected override void Instil(ContentManager Content)
    {
      ...
      this.spawn = new Spawns?(Spawns.PlayerSpawn);
      this.type = TileType.PlayerSpawn;
