...
// Type: AutonomyTheGame.Autonomy0._1.DroneSpawn
...
{
  [Serializable]
  internal class DroneSpawn : Tile
  {
    public DroneSpawn(ContentManager Content, float x, float y)
      : base(x, y)
      => this.Instil(Content);
    ...
    protected override void Instil(ContentManager Content)
    {
      ...
      this.spawn = new Spawns?(Spawns.Drone);
      this.type = TileType.DroneSpawn;
